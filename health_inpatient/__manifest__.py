...

{
    ...
    'data': [
        ...
        'views/gnuhealth_bed_transfer_view.xml',
        'views/gnuhealth_inpatient_diet_view.xml',
        'views/gnuhealth_inpatient_diet_therapeutic_view.xml',
        'views/gnuhealth_inpatient_meal_view.xml',
        'views/gnuhealth_inpatient_meal_order_view.xml',
        'views/gnuhealth_inpatient_meal_order_item_view.xml',
        'views/gnuhealth_inpatient_med_admin_time_view.xml',
        'views/gnuhealth_inpatient_med_log_view.xml',
        'views/gnuhealth_inpatient_medication_view.xml',
