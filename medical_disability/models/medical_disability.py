...
class MedicalPatient(models.Model):
    ...
    amputations = fields.One2many('medical.patient.amputation',
                                  'patient',
                                  'Amputations')

    protheses = fields.One2many('medical.patient.prothesis',
                                'patient',
                                'Protheses')
...
class BodyFunctionCategory(models.Model):
    _name = 'medical.body_function.category'
...
class BodyFunction(models.Model):
    ...
    code = fields.Char('Code',
                       required=True,
                       index=True)
    category = fields.Many2one('medical.body_function.category',
                               'Category')
...
class BodyStructureCategory(models.Model):
    _name = 'medical.body_structure.category'
...
class BodyStructure(models.Model):
    ...
    code = fields.Char('Code',
                       required=True,
                       index=True)
    category = fields.Many2one('medical.body_structure.category',
                               'Category')
...
class ActivityAndParticipationCategory(models.Model):
    _name = 'medical.activity_and_participation.category'
...
class ActivityAndParticipation(models.Model):
    _name = 'medical.activity_and_participation'
    ...
    category = fields.Many2one(
        'medical.activity_and_participation.category',
        'Category')
...
class EnvironmentalFactorCategory(models.Model):
    _name = 'medical.environmental_factor.category'
...
class EnvironmentalFactor(models.Model):
    _name = 'medical.environmental_factor'
    ...
    code = fields.Char('Code',
                       ...
                       index=True)
    category = fields.Many2one(
        'medical.environmental_factor.category',
        'Category')
...
class PatientDisabilityAssessment(models.Model):
    _name = 'medical.patient.disability_assessment'
    ...
    body_functions = fields.One2many('medical.body_function.assessment',
                                     'assessment',
                                     'Body Functions Impairments')

    body_structures = fields.One2many('medical.body_structure.assessment',
                                      'assessment',
                                      'Body Structures Impairments')

    activity_and_participation = fields.One2many(
        'medical.activity.assessment',
        'assessment',
...
class PatientBodyFunctionAssessment(models.Model):
    _name = 'medical.body_function.assessment'
    _description = 'Body Functions Assessment'
    _rec_name = 'display_name'

    assessment = fields.Many2one('medical.patient.disability_assessment',
                                 'Assessment',
                                 required=True)

    body_function = fields.Many2one(
        'medical.body_function',
        'Body Function')
...
class PatientBodyStructureAssessment(models.Model):
    _name = 'medical.body_structure.assessment'
    _description = 'Body Functions Assessment'
    _rec_name = 'display_name'
    ...
    assessment = fields.Many2one('medical.patient.disability_assessment',
                                 'Assessment',
                                 required=True)
    body_structure = fields.Many2one('medical.body_structure',
                                     'Body Structure')
...
class PatientActivityAndParticipationAsssessment(models.Model):
    _name = 'medical.activity.assessment'
    ...
    activity_and_participation = fields.Many2one(
        'medical.activity_and_participation',
        'Activity')
...
class PatientEnvironmentalFactorAssessment(models.Model):
    _name = 'medical.environment.assessment'
...
class PatientAmputation(models.Model):
    _name = 'medical.patient.amputation'
...
class PatientProthesis(models.Model):
    _name = 'medical.patient.prothesis'
...
class PatientData(models.Model):
    ...
    disability_assesments = fields.One2many('medical.patient.disability_assessment',
                                            'patient',
                                            'Assessment',
                                            readonly=True)
